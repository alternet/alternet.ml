...
The [Jetty tests](../security-jetty/surefire-report.html) show how a password is captured
([source code](https://github.com/alternet/alternet.ml/blob/master/security-jetty/src/test/java/ml/alternet/test/security/web/jetty/RESTTest.java)).
...
The [Tomcat tests](../security-tomcat/surefire-report.html) show how a password is captured
([source code](https://github.com/alternet/alternet.ml/blob/master/security-tomcat/src/test/java/ml/alternet/test/security/web/tomcat/RESTTest.java)).
...
```
cd /path/to/projects/ml.alternet/security-tomcat
...
However a cleaner way would be to build a hash from the password
(plus a random salt per password) and to have an authenticator that
