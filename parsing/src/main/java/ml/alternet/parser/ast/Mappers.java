...
public interface Mappers<T> extends Stackable<Value<T>>, ValueMapper<T> {
    ...
    default Mappers<T> setTokenMapper(Class<? extends Enum<? extends TokenMapper<T>>> tokenMapper) {
     ...
     * @return This, for chaining.
     */
    default Mappers<T> setTokenMapper(Map<String, TokenMapper<T>> tokenMapper) {
        getTokenMapper().clear();
     ...
     * @return This, for chaining.
     */
    default Mappers<T> setRuleMapper(Map<String, RuleMapper<T>> ruleMapper) {
        getRuleMapper().clear();
     ...
     */
    @SuppressWarnings({ "unchecked" })
    default Mappers<T> setRuleMapper(Class<? extends Enum<? extends RuleMapper<T>>> ruleMapper) {
        getRuleMapper().clear();
