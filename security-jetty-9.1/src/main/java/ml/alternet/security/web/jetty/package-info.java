/**
 * Handle safe passwords inside the Jetty Web server, meaning that in the
 * Web processing chain, a password NEVER appear as a String (unsafe)
 * inside the Jetty server.
 *
 * <p>This package focus on handling the passwords inside the Jetty Web
